...
export ICONS_SPACE=(󰎡 󰎤 󰎧 󰎪 󰎭 󰎱 󰎳 󰎶 󰎹 󰎼 󰽽)
...
export ICON_LIST=󱓧 # taskwarrior, taskwarrior-tui, reminders, onenote
...
export ICON_PASSKEY=󱉼 # 1password
...
export ICON_APP_SLACK=󰒱
export ICON_APP_OUTLOOK=󰴢
export ICON_APP_TEAMS=󰊻
export ICON_APP_DISCORD=󰙯
export ICON_APP_SPOTIFY=
